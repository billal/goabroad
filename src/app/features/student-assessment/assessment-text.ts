...
export const assessmentEnglish = {
  ...
  doneText:
    'Your questionnaire is complete. Explore the research pilot below. Completed answers stay in memory until refresh; no information has been submitted.',
...
export const assessmentBengali: AssessmentText = {
  ...
  results: 'মূল্যায়নের ফলাফল',
  done: 'প্রশ্নমালা সম্পন্ন',
  doneText:
    'আপনার প্রশ্নমালা সম্পন্ন হয়েছে। নিচে গবেষণার নমুনা দেখুন। রিফ্রেশ করা পর্যন্ত উত্তর মেমোরিতে থাকে; কোনো তথ্য পাঠানো হয়নি।',
